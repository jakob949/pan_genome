...
def main(input_dir, output_dir, max_seq_length, target_batch_size, use_bf16, pca_components, break_point=np.inf):
    ...
    times.append(["Clustering", round(s_c-time.time(), 2)])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", 
                        ...
                        default="/data/nilar/pan_genome/full_analysis_output/bp_20_all_peps_seq_large")
    ...
    main(args.input_dir, args.output_dir, args.max_seq_length, args.target_batch_size, args.use_bf16, args.pca_components, args.break_point)
